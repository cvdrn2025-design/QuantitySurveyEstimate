...
// Versi: 3.3 - Complete Database with All Items
// ============================================
        ...
        items: {
            ...
            lantai_beton: {
                ...
                hitung: function(data) {
                    ...
                    // Berat jenis berdasarkan ukuran
                    const beratJenisMap = {
                    ...
                    // Arah X: jumlah batang = (lebar / jarak) + 1
                    const jmlX = Math.floor(l / jarakXM) + 1;
                    // Arah Y: jumlah batang = (panjang / jarak) + 1
                    ...
                    const kebutuhanBeton = volumeBeton * 1.05; // 5% waste
                    const luasTotal = luas;
                ...
                display: function(item) {
                    return {
                        ...
                        detail: `
                            ...
                            <span><i class="fas fa-arrows-alt"></i> ${(item.tebal || 0).toFixed(3)} m</span>
                            <span><i class="fas fa-vector-square"></i> ${(item.luas || 0).toFixed(2)} m²</span>
                            <span><i class="fas fa-weight-hanging"></i> Tulangan ${item.ukuranBesi || 'M8/D8'}: ${(item.beratBesi || 0).toFixed(2)} kg</span>
