...
// Versi: 3.4 - Complete Database with Dynamic Dropdown
// ============================================
...
const DATABASE = {
    ...
    Pekerjaan_Lantai: {
        ...
        items: {
            ...
            // ----- LANTAI BETON (UPDATED dengan Dynamic Dropdown) -----
            lantai_beton: {
                id: 'lantai_beton',
                nama: 'Lantai Beton',
                icon: 'fa-cube',
                ...
                fields: [
                    ...
                    // TULANGAN - JENIS (akan mengubah dropdown ukuran)
                    { 
                        id: 'jenisTulangan', 
                        label: 'Jenis Tulangan', 
                        type: 'select', 
                        options: ['Wiremesh', 'Besi Polos', 'Besi Ulir'], 
                        default: 'Wiremesh',
                        hint: 'Pilih jenis tulangan untuk menentukan ukuran yang tersedia'
                    },
                    
                    // TULANGAN - UKURAN (dynamic berdasarkan jenis)
                    { 
                        id: 'ukuranBesi', 
                        label: 'Ukuran Besi/Wiremesh', 
                        type: 'select', 
                        options: ['M6', 'M8', 'M10', 'M12', 'M13'], 
                        default: 'M8',
                        dynamicOptions: {
                            'Wiremesh': ['M6', 'M8', 'M10', 'M12', 'M13'],
                            'Besi Polos': ['8mm', '9mm', '10mm', '11mm', '12mm'],
                            'Besi Ulir': ['D10', 'D13']
                        },
                        hint: 'Ukuran berdasarkan jenis tulangan yang dipilih'
                    },
                ...
                hitung: function(data) {
                    ...
                    // Berat jenis berdasarkan ukuran dan jenis
                    const beratJenisMap = {
                        // Wiremesh
                        'M6': 0.222, 'M8': 0.395, 'M10': 0.617, 'M12': 0.888, 'M13': 1.040,
                        // Besi Polos (mm)
                        '8mm': 0.395, '9mm': 0.499, '10mm': 0.617, '11mm': 0.746, '12mm': 0.888,
                        // Besi Ulir
                        'D10': 0.617, 'D13': 1.040
                    };
                ...
                display: function(item) {
                    return {
                        ...
                        detail: `
                            ...
                            <span><i class="fas fa-weight-hanging"></i> ${item.ukuranBesi || 'M8'}: ${(item.beratBesi || 0).toFixed(2)} kg</span>
...
// ============================================
// FUNGSI UNTUK DYNAMIC DROPDOWN
// ============================================
function getUkuranBesiOptions(jenisTulangan) {
    const options = {
        'Wiremesh': ['M6', 'M8', 'M10', 'M12', 'M13'],
        'Besi Polos': ['8mm', '9mm', '10mm', '11mm', '12mm'],
        'Besi Ulir': ['D10', 'D13']
    };
    return options[jenisTulangan] || options['Wiremesh'];
}

function getBeratJenis(ukuranBesi) {
    return BERAT_JENIS_BESI[ukuranBesi] || 0.617;
}
...
if (typeof module !== 'undefined' && module.exports) {
    ...
    module.exports.getUkuranBesiOptions = getUkuranBesiOptions;
    module.exports.getBeratJenis = getBeratJenis;
}

if (typeof window !== 'undefined') {
    window.DATABASE = DATABASE;
    window.BERAT_JENIS_BESI = BERAT_JENIS_BESI;
    window.getUkuranBesiOptions = getUkuranBesiOptions;
    window.getBeratJenis = getBeratJenis;
    console.log('✅ Database loaded!');
    const totalJenis = Object.keys(DATABASE).length;
    const totalItems = Object.values(DATABASE).reduce((acc, j) => acc + Object.keys(j.items).length, 0);
    console.log(`📊 ${totalJenis} jenis pekerjaan, ${totalItems} item pekerjaan`);
    console.log('📋 Dynamic dropdown untuk Lantai Beton siap!');
                                                                 }
