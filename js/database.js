...
// Versi: 3.0 - Complete Construction Database
// ============================================
        ...
        items: {
            ...
            balok: {
                ...
                fields: [
                    ...
                    { id: 'beratJenis', label: 'Berat Jenis Tulangan (kg/m)', type: 'number', step: 0.001, default: 1.58 },
            ...
            kolom_bulat: {
                ...
                hitung: function(data) {
                    ...
                    const beratTulangan = t * jmlTul * bUtama * jml;
        ...
        items: {
            ...
            pasang_bata: {
                ...
                hitung: function(data) {
                    ...
                    const jmlBata = vol * 70; // Perkiraan jumlah bata per m³
            ...
            plesteran: {
                ...
                hitung: function(data) {
                    ...
                    return { 
                        ...
                        satuan: 'm³', 
                        luas,
                        kebutuhanMortar: luas * 0.02 // perkiraan
                    };
                },
                display: function(item) {
                    return {
        ...
        items: {
            ...
            lantai_keramik: {
                ...
                hitung: function(data) {
                    ...
                    const jmlKeramik = luas * 1.05; // 5% waste
            ...
            lantai_beton: {
                ...
                satuan: 'm³',
                fields: [
                    { id: 'namaItem', label: 'Nama Pekerjaan', type: 'text', default: 'Lantai Beton', required: true },
                    { id: 'material', label: 'Mutu Beton', type: 'select', options: ['Beton K-200', 'Beton K-225', 'Beton K-250', 'Beton K-300'], default: 'Beton K-225' },
                    { id: 'panjang', label: 'Panjang (m)', type: 'number', step: 0.001, default: 10.00, required: true },
                    { id: 'lebar', label: 'Lebar (m)', type: 'number', step: 0.001, default: 8.00, required: true },
                    { id: 'tebal', label: 'Tebal (m)', type: 'number', step: 0.001, default: 0.12, required: true },
                    { id: 'luasLubang', label: 'Luas Lubang (m²)', type: 'number', step: 0.001, default: 0 },
                    { id: 'tulangan', label: 'Tulangan', type: 'select', options: ['Tanpa Tulangan', 'Wiremesh M6', 'Wiremesh M8', 'Wiremesh M10', 'Besi'], default: 'Wiremesh M8' }
                ],
                hitung: function(data) {
                    const luas = (data.panjang || 0) * (data.lebar || 0) - (data.luasLubang || 0);
                    const volume = luas * (data.tebal || 0);
                    
                    return { 
                        volume: isNaN(volume) || volume < 0 ? 0 : volume, 
                        satuan: 'm³', 
                        luas,
                        kebutuhanBeton: volume * 1.05
                    };
                },
                display: function(item) {
                    return {
                        ...
                        detail: `
                            ...
                            <span><i class="fas fa-arrows-alt"></i> ${(item.tebal || 0).toFixed(3)} m</span>
                            <span><i class="fas fa-vector-square"></i> ${(item.luas || 0).toFixed(2)} m²</span>
                            <span><i class="fas fa-vector-square"></i> ${item.tulangan || 'Wiremesh M8'}</span>
                        `
                    };
                }
            },
            ...
            cat_dinding: {
                ...
                hitung: function(data) {
                    ...
                    return { 
                        ...
                        satuan: 'm²', 
                        kebutuhan,
                        kebutuhanCat: kebutuhan / 10 // 1 kg cat untuk 10m²
                    };
                },
                display: function(item) {
                    return {
...
if (typeof window !== 'undefined') {
    ...
    console.log('🏗️ QSE Pro Database v3.0 - Complete Construction Database');
                     }
