...
// Versi: 3.6 - Complete with Jalan & Drainase
// BAGIAN 1
// ============================================
...
// QSE PRO - DATABASE JENIS PEKERJAAN & RUMUS
// Versi: 3.6 - Complete with Jalan & Drainase
// BAGIAN 2 - PEKERJAAN JALAN & DRAINASE
// ============================================

// Lanjutan dari DATABASE yang sudah ada
// Tambahkan ini di akhir file database.js setelah Pekerjaan_Kusen
        ...
        items: {
            ...
            paving_block: {
                ...
                hitung: function(data) {
                    ...
                    const luas = p * l;
                    const luasTotal = luas * (1 + waste);
                    const jmlPaving = Math.ceil(luasTotal * 44); // 44 biji per m² untuk ukuran 20x10
                    return {
                        volume: isNaN(luasTotal) || luasTotal < 0 ? 0 : luasTotal,
                        satuan: 'm²',
                        luasBersih: luas,
...
if (typeof window !== 'undefined') {
    ...
    console.log('✅ Database Bagian 2 loaded!');
    ...
    console.log('✅ Fitur baru: Pekerjaan Jalan & Pekerjaan Drainase');
            }
